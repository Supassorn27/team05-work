...
| 3. Feedback Summary | สรุป feedback ดิบจากผู้ใช้ | ผู้ใช้สามารถเข้าใจการแสดงผลอุณหภูมิและสถานะการทำงานของพัดลมบน Dashboard ได้โดยรวม แต่ยังมีข้อสงสัยเกี่ยวกับการอัปเดตข้อมูลแบบ Real-time และเงื่อนไขการเปิดพัดลมอัตโนมัติ ผู้ใช้เสนอให้เพิ่มคำอธิบายการทำงานของระบบเพื่อให้เข้าใจได้ง่ายขึ้น |
...
| 6. Prototype v2 Plan | จะปรับอะไรใน Sprint 5 |   1. ปรับการอัปเดตข้อมูลให้เร็วขึ้น 2. เพิ่มข้อความอธิบายสถานะระบบ3. เพิ่มระบบแจ้งเตือนอุณหภูมิ |
